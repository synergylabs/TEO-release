// libtot's Client interface to faciliate C/C++ native integration with mobile client
#ifndef LIBTOT_LIBTOT_CLIENT_NATIVE_H
#define LIBTOT_LIBTOT_CLIENT_NATIVE_H
...
#endif // LIBTOT_LIBTOT_CLIENT_NATIVE_H
